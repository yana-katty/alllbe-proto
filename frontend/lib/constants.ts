// Mock Experience データ型定義（Backend schemaに準拠）
export interface Experience {
  ...
  description?: string
  highlights?: string[]
  experienceType: 'scheduled' | 'period' | 'flexible'
